  ...
  if (payload.assesmen_nyeri?.merasakan_nyeri === '1') {
    ...
    if (an.pencetus) {
      nyeriConditional.push({
        selector:
          'textarea[name="PeriksaFisik[nyeri_pencetus]"], textarea#nyeri_pencetus, textarea[name="nyeri_pencetus"]',
        value: an.pencetus,
        type: 'textarea',
      });
    }
    if (an.kualitas) {
      nyeriConditional.push({
        selector:
          'textarea[name="PeriksaFisik[nyeri_kualitas]"], textarea#nyeri_kualitas, textarea[name="nyeri_kualitas"]',
        value: an.kualitas,
        type: 'textarea',
      });
    }
    if (an.lokasi) {
      nyeriConditional.push({
        selector:
          'textarea[name="PeriksaFisik[nyeri_lokasi]"], textarea#nyeri_lokasi, textarea[name="nyeri_lokasi"]',
        value: an.lokasi,
        type: 'textarea',
      });
    }
